const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'places.addToAllDays': 'Zu allen Tagen hinzufügen',
  'places.multiDay': 'Mehrtägig',
  'places.assignToDay': 'Zu Tag hinzufügen/entfernen',
  'places.all': 'Alle',
  ...
  'places.googleActive': 'Suche via Google Maps (inkl. Bilder, Bewertungen & Öffnungszeiten aktiv).',
  ...
  'share.permKosten': 'Kosten',
  'share.permCollab': 'Chat',
  'share.noLabel': 'Link ohne Bezeichnung',
  'share.labelPlaceholder': 'Bezeichnung (z. B. "Familie")',
  ...
  'share.expiredTitle': 'Link abgelaufen oder ungültig',
  'share.expiredHint': 'Dieser geteilte Reiselink ist nicht mehr aktiv.',
  'share.readOnly': 'Schreibgeschützte Ansicht',
  'share.daysCount': '{count} Tage',
  'share.onePlace': 'Ort',
  'share.totalBudget': 'Gesamtbudget',
  'share.balancePerPerson': 'Bilanz pro Person',
  'share.whoOwes': 'Wer zahlt wem?',
  'share.paidShare': 'bezahlt {paid} · Anteil {owed}',
  'share.paidByName': 'von {name}',
  'share.collabNotes': 'Notizen',
  'share.bookingConfirmation': 'Buchungs-Nr.',
  'share.bookingNotes': 'Notizen',
  'share.filesAttached': 'Anhänge',
  'share.noBookings': 'Keine Buchungen',
  'share.noCollabContent': 'Keine Inhalte vorhanden',
  'share.messagesCount': '{count} Nachrichten',
