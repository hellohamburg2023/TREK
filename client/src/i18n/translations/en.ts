const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'places.addToAllDays': 'Add to all days',
  'places.multiDay': 'Multi-day',
  'places.assignToDay': 'Add to / remove from day',
  'places.all': 'All',
  ...
  'places.googleActive': 'Search via Google Maps (incl. photos, ratings & opening hours active).',
  ...
  'share.noLabel': 'Unnamed link',
  'share.labelPlaceholder': 'Label (e.g. "Family")',
  ...
  'share.expiredTitle': 'Link expired or invalid',
  'share.expiredHint': 'This shared trip link is no longer active.',
  'share.readOnly': 'Read-only shared view',
  'share.daysCount': '{count} days',
  'share.onePlace': 'place',
  'share.totalBudget': 'Total Budget',
  'share.balancePerPerson': 'Balance per person',
  'share.whoOwes': 'Who owes whom?',
  'share.paidShare': 'paid {paid} · share {owed}',
  'share.paidByName': 'by {name}',
  'share.collabNotes': 'Notes',
  'share.bookingConfirmation': 'Booking Ref.',
  'share.bookingNotes': 'Notes',
  'share.filesAttached': 'Attachments',
  'share.noBookings': 'No bookings',
  'share.noCollabContent': 'No content available',
  'share.messagesCount': '{count} messages',
